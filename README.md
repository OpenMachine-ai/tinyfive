...
TinyFive is for you if you are new to RISC-V and you know Python.
...
Keep in mind that simplicity and size (in terms of number of instructions) is a key property
